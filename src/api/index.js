...
export const login = (data) => ajax.post('/api-token-auth/', data);


export const  verify_token = (data) => ajax.post('/api-token-verify/', data);

export const getSnkrank = () => ajax.get('/zqzb/snkrank/');
